/*
  # Update battle completion and statistics tracking

  1. New Functions
    - update_dot_statistics: Updates statistics for a dot after battle
    - complete_battle: Handles battle completion and updates all related data

  2. Changes
    - Fixed loop syntax in complete_battle function
    - Added proper error handling
    - Added battle summary creation
*/
