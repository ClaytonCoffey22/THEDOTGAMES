/*
  # Fix GROUP BY issue in complete_battle function

  1. Changes
    - Update complete_battle function to properly handle u.id in GROUP BY clause
    - Ensure all non-aggregated columns are included in GROUP BY
    - Maintain data integrity while fixing the SQL error

  Note: This migration preserves all existing functionality while fixing the GROUP BY issue
*/
